<?php
session_start();
require_once "../Models/Plastiques.php";
    ...
    switch ($action) {
        case 'create':
            if (isset($_POST) && !empty($_POST)) {
                ...
                if (!empty($_FILES['plastique_image']['name'])) {
                    $image_name = $_FILES['plastique_image']['name'];
                    $file_tmp_name = $_FILES['plastique_image']['tmp_name'];
